...
import { solutions, callsToAction, resources, recentTests } from './data'
                ...
                <div className="flex justify-start lg:w-0 lg:flex-1">
                    <a href="#">
                        ...
                        <img
                            ...
                            src="https://icons8.com/wp-content/uploads/2020/03/bab-yoda-1024x1024.jpeg"
                            alt="bbyoda"
                        />
                    </a>
                </div>
                                    ...
                                    <Popover.Panel className="absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 transform px-2 sm:px-0">
                                        <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                                            ...
                                            <div className="bg-gray-50 px-5 py-5 sm:px-8 sm:py-8">
                                                <div>
                                                    <h3 className="text-base font-medium text-gray-500">Recent Tests</h3>
                                                    <ul role="list" className="mt-4 space-y-4">
                                                        {recentTests.map((post) => (
